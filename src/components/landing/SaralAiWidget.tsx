      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`fixed inset-x-3 bottom-3 z-[90] origin-bottom-right overflow-hidden rounded-3xl bg-white sm:inset-x-auto sm:bottom-6 sm:right-6 sm:w-[400px] ${SHADOW} ${pending ? 'h-[min(600px,88svh)]' : 'max-h-[88svh]'}`}
          >
